...
// 
std::string  SFF8024::ident(int code) {
	std::string s;
	switch (code) {
...
std::string SFF8024::connector_type(int code) {
	std::string s;
	switch (code) {
...
// SFF8024 tabel 4-4
std::string  SFF8024::exttype(int code) {
	std::string s;
	switch (code) {
...
std::string SFF8024::tech(int code) {
	std::string s;
	switch (code)
	{
...
// sff8024_table Table 4 - 5 Host Electrical Interface IDs
std::string SFF8024::ehint(int code) {
	std::string s;
	switch (code)
	{
...
// sff8024_table Table 4 - 5 Host Electrical Interface IDs
std::string SFF8024::smfint(int code) {
	std::string s;
	switch (code)
	{
...
// sff8024_table Table 4 - 5 Host Electrical Interface IDs
std::string SFF8024::mmfint(int code) {
	std::string s;
	switch (code)
	{
...
std::string SFF8024::optype(int code) {
	std::string s;
	switch (code) {
